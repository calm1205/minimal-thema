/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+c+docker+git+go+graphql+haml+json+markup-templating+nginx+php+python+jsx+tsx+ruby+sass+scss+sql+typescript+yaml&plugins=line-highlight+line-numbers+show-language+normalize-whitespace+toolbar+copy-to-clipboard */
var _self =
